...
public class DataDriveScreen extends ContainerScreen<DataDriveContainer> {
    ...
    public int getLightState(){
        ...
        drive.getCapability(MCapabilities.OPENER_CAPABILITY).ifPresent(cap -> {
            ...
            if(!stack.getItem().equals(ModItems.BURNED_DATA_CRYSTAL.get()) && !stack.getItem().equals(ItemStack.EMPTY.getItem())){
                inte.set(2);
            }
        });
        return inte.get();
    ...
    public TranslationTextComponent getState(){
        ...
        drive.getCapability(MCapabilities.OPENER_CAPABILITY).ifPresent(cap -> {
            ...
            else if(stack.getItem().equals(ModItems.BURNED_DATA_CRYSTAL.get())) {
