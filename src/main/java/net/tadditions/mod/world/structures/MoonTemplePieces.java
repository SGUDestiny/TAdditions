...
public class MoonTemplePieces {
	
	private static final ResourceLocation MOONTEMPLE = new ResourceLocation(QolMod.MOD_ID, "moon_temple");
	private static final Map<ResourceLocation, BlockPos> OFFSET = ImmutableMap.of(MOONTEMPLE, BlockPos.ZERO);
	...
	public static void start(TemplateManager templateManager, BlockPos pos, Rotation rotation, List<StructurePiece> pieceList, Random random) {
        ...
        pieceList.add(new MoonTemplePieces.Piece(templateManager, MOONTEMPLE, blockpos, rotation));
    }
	...
	public static class Piece extends TemplateStructurePiece {
		...
		public Piece(TemplateManager templateManagerIn, ResourceLocation resourceLocationIn, BlockPos pos, Rotation rotationIn) {
			super(MStructures.Structures.MOON_TEMPLE_PIECE, 0);
			this.resourceLocation = resourceLocationIn;
	        BlockPos blockpos = MoonTemplePieces.OFFSET.get(resourceLocation);
		...
		public Piece(TemplateManager templateManagerIn, CompoundNBT tagCompound) {
            super(MStructures.Structures.MOON_TEMPLE_PIECE, tagCompound);
        ...
        protected void handleDataMarker(String function, BlockPos pos, IServerWorld worldIn, Random rand, MutableBoundingBox sbb) {
        	if ("moon_temple_loot_table".equals(function)) {
