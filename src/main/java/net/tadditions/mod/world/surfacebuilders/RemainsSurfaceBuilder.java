...
public class RemainsSurfaceBuilder extends SurfaceBuilder<SurfaceBuilderConfig> {
    public RemainsSurfaceBuilder(Codec<SurfaceBuilderConfig> codec) {
        super(codec);
    }
    ...
    protected void buildSurface(Random random, IChunk chunkIn, Biome biomeIn, int x, int z, int startHeight, double noise, BlockState defaultBlock, BlockState defaultFluid, BlockState top, BlockState middle, BlockState bottom, int sealevel) {
        ...
        int k = x & 15;
        int l = z & 15;
        int variation = random.nextInt(3); // Random variation between 0 and 2 (inclusive)
        ...
        for (int i1 = startHeight; i1 >= 0; --i1) {
            ...
            if (blockstate2.isAir()) {
                ...
                if (i == -1) {
                    ...
                    } else if (i1 < sealevel - 7 - j + variation) {
                        blockstate = Blocks.AIR.getDefaultState();
                        blockstate1 = defaultBlock;
                    ...
                    if (i == 0 && blockstate1.matchesBlock(Blocks.SAND) && j > 1) {
                        i = random.nextInt(4) + Math.max(0, i1 - 63 + variation);
