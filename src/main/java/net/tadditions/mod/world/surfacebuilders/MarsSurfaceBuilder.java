...
/**
 * Settings that define how a biome generates its top layer blocks on the world terrain
 * <br> Used for the Moon Field Biome
 *
 * @author 50ap5ud5
 */
public class MarsSurfaceBuilder extends SurfaceBuilder<SurfaceBuilderConfig> {
    public MarsSurfaceBuilder(Codec<SurfaceBuilderConfig> codec) {
        super(codec);
    }
