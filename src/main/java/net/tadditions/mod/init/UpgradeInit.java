...
{
    public static final DeferredRegister<UpgradeType<?, ? extends Upgrade<?>>> UPGRADES = DeferredRegister.create(Helper.createRL("upgrades"), TemporalAdditionsMod.MOD_ID);
