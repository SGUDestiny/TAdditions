...
public class MNetwork {
    ...
    public static void init() {
        ...
        NETWORK_CHANNEL.registerMessage(nextId(), CloakingUpdateMessage.class, CloakingUpdateMessage::encode, CloakingUpdateMessage::decode, CloakingUpdateMessage::handle);
    }
