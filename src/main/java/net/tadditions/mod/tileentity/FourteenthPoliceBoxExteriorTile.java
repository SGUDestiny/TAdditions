...
public class FourteenthPoliceBoxExteriorTile extends ExteriorTile {
    ...
    public FourteenthPoliceBoxExteriorTile(TileEntityType<?> tileEntityTypeIn) {
        super(tileEntityTypeIn);
    }

    public FourteenthPoliceBoxExteriorTile() {
        super(ModTileEntitys.EXTERIOR_FOURTEENTH_POLICE_BOX.get());
    }
