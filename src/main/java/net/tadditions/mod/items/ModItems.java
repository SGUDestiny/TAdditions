...
public class ModItems {
    ...
    public static final RegistryObject<Item> THERMAL_PROTECTION_UPGRADE = ITEMS.register("upgrades/thermal_protection", () -> createItem(new TardisPartItem(TardisConstants.Part.PartType.UPGRADE, false, true    , TardisConstants.Translations.TEMPORAL_GRACE)));
    public static final RegistryObject<Item> EC2_UPGRADE = ITEMS.register("upgrades/ec2", () -> createItem(new TardisPartItem(TardisConstants.Part.PartType.UPGRADE, false, true, TardisConstants.Translations.TEMPORAL_GRACE)));
    public static final RegistryObject<Item> NOBADOMEN_UPGRADE = ITEMS.register("upgrades/goodomen", () -> createItem(new TardisPartItem(TardisConstants.Part.PartType.UPGRADE, true, false, TardisConstants.Translations.TEMPORAL_GRACE)));
    public static final RegistryObject<Item> ZR2_UPGRADE = ITEMS.register("upgrades/zr2", () -> createItem(new TardisPartItem(TardisConstants.Part.PartType.UPGRADE, false, true, TardisConstants.Translations.TEMPORAL_GRACE)));
    public static final RegistryObject<Item> FRAME_UPGRADE = ITEMS.register("upgrades/frame_stabilizer", () -> createItem(new TardisPartItem(TardisConstants.Part.PartType.UPGRADE, false, true, new TranslationTextComponent("item." + QolMod.MOD_ID + ".subsystem.stabilizers"))));
