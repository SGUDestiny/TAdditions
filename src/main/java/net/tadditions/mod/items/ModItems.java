...
public class ModItems {
    ...
    public static final RegistryObject<Item> FRAME_UPGRADE = ITEMS.register("upgrades/frame_stabilizer", () -> createItem(new TardisPartItem(Prop.Items.ONE.get().group(ModItemGroups.TA).maxDamage(1000), TardisConstants.Part.PartType.UPGRADE, false, true, new TranslationTextComponent("item." + QolMod.MOD_ID + ".subsystem.stabilizers"))));
