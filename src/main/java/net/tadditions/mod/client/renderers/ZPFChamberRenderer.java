...
public class ZPFChamberRenderer extends GeoBlockRenderer<ZPFChamberTile> {
    public ZPFChamberRenderer(TileEntityRendererDispatcher rendererDispatcherIn) {
        super(rendererDispatcherIn, new ZPFChamberModel());
    }
    ...
    @Override
    public float getHeightScale(ZPFChamberTile entity) {
        return 0.65F;
    }

    @Override
    public float getWidthScale(ZPFChamberTile animatable2) {
        return 0.65F;
    }
}
