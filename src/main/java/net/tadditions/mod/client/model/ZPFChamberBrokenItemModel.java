...
public class ZPFChamberBrokenItemModel extends AnimatedGeoModel<AnimatedMultiblockBlockItem> {
    ...
    @Override
    public ResourceLocation getModelLocation(AnimatedMultiblockBlockItem object) {
        return modelResource;
    }

    @Override
    public ResourceLocation getTextureLocation(AnimatedMultiblockBlockItem object) {
        return textureResource;
    }

    @Override
    public ResourceLocation getAnimationFileLocation(AnimatedMultiblockBlockItem object) {
