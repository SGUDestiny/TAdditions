...
public class ContainmentChamberItemModel extends AnimatedGeoModel<ContainmentChamberItem> {
    ...
    public ResourceLocation getModelLocation(ContainmentChamberItem object) {
        return object.getBroken(new ItemStack(object)) ? new ResourceLocation(QolMod.MOD_ID, "geo/containment_chamber_broken.geo.json") : modelResource;
    }

    @Override
    public ResourceLocation getTextureLocation(ContainmentChamberItem object) {
        return object.getBroken(new ItemStack(object)) ? new ResourceLocation(QolMod.MOD_ID, "textures/block/containment_chamber_broken.png") : animateTexture(animo);
    }

    @Override
    public ResourceLocation getAnimationFileLocation(ContainmentChamberItem object) {
        return object.getBroken(new ItemStack(object)) ? new ResourceLocation(QolMod.MOD_ID, "animations/containment_chamber_broken.animation.json") : animationResource;
    }
