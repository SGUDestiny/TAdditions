...
public class ZPFChamberModel extends AnimatedGeoModel<ZPFChamberTile> {
    ...
    @Override
    public ResourceLocation getModelLocation(ZPFChamberTile object) {
        return modelResource;
    }

    @Override
    public ResourceLocation getTextureLocation(ZPFChamberTile object) {
        return animateTexture(animo);
    }

    @Override
    public ResourceLocation getAnimationFileLocation(ZPFChamberTile object) {
